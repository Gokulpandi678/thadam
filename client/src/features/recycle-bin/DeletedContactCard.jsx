...
const DeletedContactCard = ({ customer, onRestore, onDelete }) => {
    ...
    return (
        <div className="grid items-center gap-4 px-4 py-3 bg-white border border-gray-100 rounded-xl hover:border-gray-200 transition-colors"
            style={{ gridTemplateColumns: "42px 1fr 1fr 1fr 1fr auto" }}>
