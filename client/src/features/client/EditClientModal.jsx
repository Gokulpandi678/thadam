...
import ContactDrawer from "../customer/component/form/ContactDrawer";
import contactDrawerTabs from "../customer/component/form/contactDrawerConfig";
...
const EditClientModal = ({ isOpen, onClose, client }) => {
    ...
    const { form, errors, onChange, validate, serialise } =
        useContactDrawerForm(client, isOpen);
