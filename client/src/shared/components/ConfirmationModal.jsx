 ...
 * @param {"danger"|"warning"} variant - Visual style
 * @param {boolean}   isLoading    - Disables buttons during async operations
 * @param {ReactNode} icon         - Optional icon override
 */
      ...
      >
        ...
        <div className="flex gap-2 justify-end mt-4">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className={`px-4 py-1.5 text-xs rounded-lg font-medium transition-colors cursor-pointer ${confirmClasses} disabled:opacity-50`}
          >
