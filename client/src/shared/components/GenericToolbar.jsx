...
const GenericToolbar = ({
  ...
  return (
    <div className="mt-5 w-full">
      <div className="flex w-full items-center gap-2 rounded-3xl border border-white/70 bg-white/90 p-3 shadow-sm sm:p-4">

        {/* LEFT GROUP: flex-1 fills all space on mobile, fixed width on desktop */}
        <div className="flex flex-1 min-w-0 items-center gap-2">

          {/* Search — fills remaining space on mobile, fixed on desktop */}
          <div className="flex-1 md:w-64 md:flex-none lg:w-80">
            <InputBox
          ...
          <div className="relative shrink-0" ref={filterMenuRef}>
            ...
            {showFilterMenu && (
              <div className="absolute left-0 z-20 mt-2 w-72 max-w-[calc(100vw-2rem)] rounded-2xl border border-gray-200 bg-white p-3 shadow-xl">
          ...
          {table && (
            <div className="relative hidden shrink-0 md:block" ref={columnMenuRef}>
              ...
              {showColumnMenu && (
                <div className="absolute left-0 z-20 mt-2 w-[min(18rem,calc(100vw-2rem))] rounded-2xl border border-gray-200 bg-white p-3 shadow-xl">
        ...
        {/* SPACER — desktop only, pushes right group to far end */}
        <div className="hidden flex-1 md:block" />

        {/* RIGHT GROUP: Count + Add button — desktop only */}
      ...
      {/* Add button — fixed bottom-right on mobile, count never shown */}
      {rightSlot && (
